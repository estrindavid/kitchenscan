...
export default function EditPreferencesScreen() {
  ...
  const currentSkill = usePrefsStore((s) => s.skillLevel);
  const currentHousehold = usePrefsStore((s) => s.householdSize);
  ...
  const [household, setHousehold] = useState(String(currentHousehold));
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Typography variant="h2">Edit Preferences</Typography>
